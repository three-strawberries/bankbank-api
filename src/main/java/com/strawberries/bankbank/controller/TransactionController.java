...
public class  TransactionController {
    ...
    public ResponseEntity<Transaction> addTransaction(@RequestBody Transaction transaction) throws SQLException {
    ...
    public ResponseEntity<Void> updateTransaction(@PathVariable int idTransaction, @RequestBody Transaction transactionUpdate) throws SQLException {
